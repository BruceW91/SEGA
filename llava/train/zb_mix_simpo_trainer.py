...
class LLaVATrainer_DPO(Trainer):
    ...
    def preference_loss(self, policy_chosen_logps: torch.FloatTensor,
        ...
        gamma_logratios = self.gamma / self.beta    # default gamma=0.5, beta=2.0
        ...
        # The rewards are the logits of the chosen and rejected responses, respectively.
