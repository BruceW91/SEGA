...
def evaluate(
        ...
        from ...dataset.subtask import pred_cotv3 as pred
        from ...dataset.subtask import ocr_cotv3 as ocr
        from ...dataset.subtask import pred_box_cotv3 as pred_box
        from ...dataset.subtask import pred_raw_cotv3 as pred_raw
