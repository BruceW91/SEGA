...
def evaluate(
        ...
        from ...dataset.subtask import ocr_ft as ocr, pred_continue_ft as pred_continue, refine_ft as refine
        from ...dataset.subtask import pred_simple_ft as pred
        from ...dataset.subtask import pred_text_step as pred_text
