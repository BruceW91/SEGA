...
def evaluate(
        ...
        from ...dataset.subtask import pred_cotv1 as pred
        from ...dataset.subtask import ocr_cotv1 as ocr
        from ...dataset.subtask import pred_continue_cotv1 as pred_continue 
        from ...dataset.subtask import refine_cotv1 as refine
