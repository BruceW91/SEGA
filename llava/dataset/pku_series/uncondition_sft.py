...
# import 子任务
# from .subtask import zb_crello_cot_simple, 
from llava.dataset.subtask.zb_subtasks import uncondition_pku_convert
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        # pku_train_p = '/root/paddlejob/workspace/log/code/pku_dataset/pku_train_dict.pkl'
        ...
        try:
            ...
            list_data_dict = [ {k:v} for k, v in pku_data.items() if k in imgs_names]
            # print("hh")
    ...
    def __getitem__(self, i):
        while True:
            try:
                ...
                dialog, image = uncondition_pku_convert.convert(sources, self.pku_inpainted_imgs_p)
