...
# import 子任务
from .subtask import zb_refine_noise_cgl_convert, zb_refine_allign_cgl_convert
...
def select_task(content, score, temp_pred, temp_saliency_map, img_folder_p):
    ...
    # 目前对齐和随机1:1
    if select_score < 0.5:
        return zb_refine_noise_cgl_convert.convert(content, img_folder_p, temp_saliency_map)
    else:
        return zb_refine_allign_cgl_convert.convert(content, score, temp_pred, img_folder_p)
    # return zb_refine_noise_pku_convert.convert(content, img_folder_p, temp_saliency_map)
        # pass
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        pku_train_p = '/root/paddlejob/workspace/log/code/others/cgl_dataset/real_train_annotation_xyxy.pkl'
        self.pku_inpainted_imgs_p = '/root/paddlejob/workspace/log/code/others/cgl_dataset/cgl_inpainting_all/'
        pku_data = pkl.load(open(pku_train_p, 'rb'))
        imgs_names = os.listdir(self.pku_inpainted_imgs_p) 

        scores_p = '/root/paddlejob/workspace/log/code/RALF-main/zb_utils_for_cot_refine/sft_nocot_3500_trainpkl.pkl'
        ...
        list_data_dict = [ (k,v) for k, v in pku_data if k.replace(".jpg", ".png") in imgs_names and k.replace(".jpg", ".png") in self.scores_names]
        ...
        self.pred_p = 'aaa_all_past_results/infer_out_cgl/sft_nocot_3500_trainpkl'
        self.saliency_map_folder = 'llava/dataset/zb_refine_noise_utils/cgl_union_sal'
