...
# import 子任务
from .subtask import pred_textnoc_cotv4_6, ocr_text, pred_raw_nocate

def select_task(pk):
    flip = np.random.rand() > 0.5
    return np.random.choice((pred_textnoc_cotv4_6.convert, ocr_text.convert, pred_raw_nocate.convert))(pk, flip)
