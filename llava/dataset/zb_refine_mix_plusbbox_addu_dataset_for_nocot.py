...
# import 子任务
from .subtask import  zb_refine_convert_baseline, zb_refine_noise_convert, zb_refine_no_detail_noise_plusbbox_add_u_convert, zb_refine_baseline_plusbbox_add_u_allign
...
def select_task(pk, score, temp_pred, temp_saliency_map):
    ...
    # 目前对齐和随机1:1
    if select_score < 0.5:
        return zb_refine_no_detail_noise_plusbbox_add_u_convert.convert_no_score(s, flip, temp_saliency_map)
    else:
        return zb_refine_baseline_plusbbox_add_u_allign.convert(s, flip, score, temp_pred)
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        scores_p = '/root/paddlejob/workspace/log/code/RALF-main/zb_utils_for_cot_refine/simple_nocot_infer_in_train_17epkl.pkl'
        # scores_p = 'zb_data/full_simplesft_17e_test_in_alltrain_rpkl.pkl'
        ...
        self.pred_p = 'infer_out_refine/simple_nocot_infer_in_train_17epkl'
