...
from llava.dataset.subtask  import no_pred_continue_cot_for_0530,zb_continue_cot_for_yewu

def select_task(pk):
    flip = np.random.rand() > 0.5
    return np.random.choice((zb_continue_cot_for_yewu.convert,))(pk, flip)
...
if __name__ == '__main__':
    ...
    dset = LazySupervisedDataset('zb_data/for_yewu/align_list_plus_charnum_all_v2.pkl', tokenizer, data_args)
