...
# import 子任务
from .subtask import crello_ocrv2_drop, crello_pred_simple, zb_crello_rag_convert
...
def select_task(pk,example_pk):
    ...
    return zb_crello_rag_convert.convert_and_merge_2_dialog(s, flip, e_s)
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        rag_path = 'zb_data/crello_train_train_dreamsim_wo_head_table_between_dataset_indexes_top_k4.pt'
