...
# import 子任务
from llava.dataset.subtask import  crello_pred_raw_continuev2_underlay_tuili,zb_crello_cot_simple
...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, ii):
        while True:
            try:
                i = random.randint(0, len(self.train_dict) - 1)
                # print("cur_poster_idx:",i)
