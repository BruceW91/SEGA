...
# import 子任务
from .subtask import zb_refine_11_6_occ_noise_convert, zb_refine_11_6_occ_align_convert
...
def select_task(pk, score, temp_pred, temp_saliency_map):
    ...
    # 目前对齐和随机1:1
    if select_score < 0.5:
        return zb_refine_11_6_occ_noise_convert.convert_no_score(s, flip, temp_saliency_map)    
    else:
        return zb_refine_11_6_occ_align_convert.convert(s, flip, score, temp_pred)
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        wash_4k_path = 'zb_data/11_6_occ_underlay_wash_bad_names_final.pkl'
        # wash_4k_path = 'zb_data/11_6_occ_wash_bad_names_final.pkl'
