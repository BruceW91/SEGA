...
# import 子任务
from .subtask import zb_refine_11_1_noise_convert, zb_refine_11_1_align_convert, zb_refine_11_1_base_align_convert
...
def select_task(pk, score, temp_pred, temp_saliency_map):
    ...
    # else:
    return zb_refine_11_1_base_align_convert.convert(s, flip, score, temp_pred)
