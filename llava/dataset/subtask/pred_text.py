...
def convert(pk, flip):
    ...
    dialog = [
        {'from': 'human',
   'value': '''<image>\n Given aa list of text, predict the corresponding category, bounding box, font size, font color, alignment for each element.The answer should be json format [{"text":xxx, "category": xxx, "char_num": xxx, "bbox": [x_min, y_min, x_max, y_max], "fontsize": xxx, "fontcolor": [red, green, blue], "alignment":xxx}, ...]'}''' + \
        f'''\ninput: {iper}'''},
        {
            'from': 'gpt',
