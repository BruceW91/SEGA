...
# import 子任务
from .subtask import  zb_refine_convert_baseline, zb_refine_noise_convert, zb_refine_no_detail_noise_convert ,  zb_refine_baseline_for_align
...
def select_task(pk, score, temp_pred, temp_saliency_map):
    ...
    # 目前对齐和随机1:1
    if select_score < 0.5:
        return zb_refine_no_detail_noise_convert.convert_no_score(s, flip, temp_saliency_map)
    else:
        return zb_refine_baseline_for_align.convert(s, flip, score, temp_pred)
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        wash_4k_path = '/root/paddlejob/workspace/log/code/RALF-main/zb_utils_data/10_14_wash_bad_names_change_saliency.pkl'
        # wash_4k_path = '/root/paddlejob/workspace/log/code/RALF-main/zb_utils_data/10_12_wash_bad_names_final.pkl'
