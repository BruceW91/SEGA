...
# import 子任务
from .subtask import  crello_pred_simple, zb_simple_crello_rag_convert, zb_simple_replace_gt_by_rag_convert
...
def select_task(pk,example_pk):
    ...
    return zb_simple_replace_gt_by_rag_convert.convert_and_merge_2_dialog(s, flip, e_s)
