...
# import 子任务
from .subtask import refine_noise_for_pku_like_convert, refine_align_for_pku_like_convert


def select_task(pk, score, temp_pred, temp_saliency_map, cur_img):
    ...
    # 目前对齐和随机1:1
    if select_score < 0.5:
        return refine_noise_for_pku_like_convert.convert_no_score(s, False, temp_saliency_map, cur_img)    
    else:
        return refine_align_for_pku_like_convert.convert(s, False, score, temp_pred, cur_img)
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        scores_p = 'crello_like_pku_sft_infer_all_trainpkl_valid.pkl'
        ...
        self.pred_p = 'infer_out/crello_like_pku_sft_infer_all_trainpkl'
        self.saliency_map_folder = 'llava/dataset/zb_refine_noise_utils/unio_pku_like_crello'
        ...
        self.imgs_p = '/root/paddlejob/workspace/log/code/RALF-main/zb_utils_data/crello_inpainting/input'  
    ...
    def __getitem__(self, i):
        while True:
            try:
                ...
                cur_img_p = os.path.join(self.imgs_p, temp_name + '.png')
                cur_img = PIL.Image.open(cur_img_p)
                ...
                dialog, image = select_task(sources, scores, temp_pred,  temp_saliency_map, cur_img)
