...
# import 子任务
from llava.dataset.subtask import zb_crello_cot_simple ,zb_simple_nocot_crello_convert

def select_task(pk):
    s = pkl.load(open(pk, 'rb'))
    flip = np.random.rand() > 0.5
    return np.random.choice((zb_simple_nocot_crello_convert.convert, ))(s, flip, True)
