...
from llava.dataset.subtask  import zb_continue_nocot_for_new_yewu_human_uncondition

def select_task(pk):
    flip = np.random.rand() > 0.5
    return np.random.choice((zb_continue_nocot_for_new_yewu_human_uncondition.convert,))(pk, flip)
