...
# import 子任务
from .subtask import zb_refine_11_13_noise_convert, zb_refine_11_13_align_convert
...
def select_task(pk, score, temp_pred, temp_saliency_map):
    ...
    # 目前对齐和随机1:1
    if select_score < 0.5:
        return zb_refine_11_13_noise_convert.convert_no_score(s, False, temp_saliency_map)    
    else:
        return zb_refine_11_13_align_convert.convert(s, False, score, temp_pred)
...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        scores_p = '/root/paddlejob/workspace/log/code/RALF-main/zb_utils_for_cot_refine/crello_train_for_posterllama_pkl_valid.pkl'
        ...
        self.pred_p = 'crello_train_for_posterllama_pkl'
        # self.pred_p = 'infer_out_rag/full_simplesft_17e_test_in_alltrain_rpkl'
        
        # self.pred_p = 'infer_out_refine/simple_nocot_sft_400_train_all_oldpkl'
