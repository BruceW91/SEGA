...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        wash_4k_path = 'zb_data/10_12_wash_bad_names_final.pkl'
    ...
    def __getitem__(self, i):
        while True:
            try:
                ...
                dino_processor = copy.deepcopy(processor)  
                dino_processor.crop_size = {'height':516,'width':516}
                dino_processor.size = {'shortest_edge': 516}
